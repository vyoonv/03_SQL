...
GROUP BY STUDENT_NO, STUDENT_NAME
ORDER BY ROUND(AVG(POINT),2) DESC ; -- 국어국문과 학생별 평점 
-- 가장 높은 사람 
SELECT STUDENT_NO,STUDENT_NAME
FROM (SELECT STUDENT_NO,STUDENT_NAME, ROUND(AVG(POINT),2) 
...
LEFT JOIN TB_GRADE USING(STUDENT_NO) WHERE DEPARTMENT_NAME 
IN (SELECT DEPARTMENT_NAME FROM TB_DEPARTMENT WHERE CATEGORY = '자연과학')
